...
public final class FindMeetingQuery {
  ...
  private Collection<TimeRange> queryHelper(Collection<Event> events, MeetingRequest request, boolean includeOptionals) {
    // The Collection that stores the available times for the requested meeting.
    ...
    // If running generating a list of available times including the optional attendees
    if (includeOptionals == false) {
      ...
      // Iterate over the HashSet of optional attendees
