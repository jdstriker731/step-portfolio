...
public final class FindMeetingQueryTest {
  ...
  // An optional person for my own tests
  ...
  @Test
  public void everyAttendeeIsConsideredWithOptionalHavingAllDayEvent() {
    // Have each person have different events, but an optional attendee has an all day
    // event. So they are ignored 
    //
    // Events  : |--------------C--------------|
    //                 |--A--|     |--B--|
    // Day     : |-----------------------------|
    ...
    // Add an optional attendee, PERSON_C, with an all day event
  ...
  @Test
  public void everyAttendeeIsConsideredWithOptionalWithEventInBetween() {
    // Have each person have different events one after the other, with an optional
    // attendee having a meeting in between them. The only options then are before the 
    // first meeting and after the last meeting.
    //
    // Events  :             |--C--|
    //                 |--A--|     |--B--|
    // Day     : |-----------------------------|
  ...
  public void justEnoughRoomWithOptional() {
    // Have two people, one is optional and they have a meeting during the only time when the 
    // required would be able to meet. So, there's no option for to include them, and they 
    // are ignored
    //
    // Events  :       |-B-| 
    //           |--A--|     |----A----|
  ...
  @Test
  public void noMandatoryAttendeesJustOptionals() {
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0830AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0930AM, DURATION_60_MINUTES),
            Arrays.asList(PERSON_A)),
  ...
  @Test
  public void noMandatoryAttendeesJustOptionalsNoTimeRange() {
